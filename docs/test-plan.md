...
- Rust FFI integration coverage for ext direct/single/double/triple-indirect and extent-leaf recovery success plus partial/unsupported fallback status handling.
